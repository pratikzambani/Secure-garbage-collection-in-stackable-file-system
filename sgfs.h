...
extern char *sg_lower_path;
extern char *sgfs_encryption_key;

extern int file_open_vfs(const char *path, int flags, int rights, struct file **ofilep);
extern void file_close_vfs(struct file **cfilep);
extern int file_read_vfs(struct file *file, unsigned long long offset, unsigned char *data, unsigned int size);
extern int file_write_vfs(struct file *file, unsigned long long offset, unsigned char *data, unsigned int size);
extern int get_hash(const char *enc_key, int enc_key_size, u8 **md5_hash);
